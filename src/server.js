...
const {dbLocal} = require("./server/database/bancoDeDados/database");
...
const startServer = async () => {
    try {
        ...
        const tabelaUsuarioCriada = await tabelasController.criaTabelaUsu(dbLocal);
        ...
        if (tabelaUsuarioCriada) {
            ...
            await tabelasController.criarTabelaBarbeiro(dbLocal);
            await tabelasController.createTabelaCliente(dbLocal);
            await tabelasController.criaTabelaHorario(dbLocal);
        } else {
